`smolgp` (State Space Models for O(Linear/Log) Gaussian Processes) is a Python/JAX extension of the [`tinygp`](https://github.com/dfm/tinygp) package that implements
