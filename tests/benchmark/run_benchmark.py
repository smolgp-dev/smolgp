...
from funcs import ss_llh, qs_llh, gp_llh, pss_llh, pqs_llh
from funcs import ss_cond, qs_cond, gp_cond, pss_cond, pqs_cond
...
if __name__ == "__main__":
    ...
    cond_funcs = [
        {"SSM": ss_cond, "QSM": qs_cond, "GP": gp_cond, "pQSM": pqs_cond, "pSSM": pss_cond},
