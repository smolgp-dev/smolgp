...
2. Scalable O(N) solving with integrated (and possibly overlapping) measurements from multiple instruments (see [Rubenzahl and Hattori et al. 2026](https://doi.org/10.3847/1538-3881/ae4d0b)).
3. Parallelized versions of 1 (see [Särkkä and García-Fernández 2020](https://ieeexplore.ieee.org/document/9013038)) and 2 (see [Rubenzahl and Hattori et al. 2026](https://doi.org/10.3847/1538-3881/ae4d0b)).
