...
def IntegratedKalmanFilter(kernel, X, y, noise, return_v_S=False):
    '''
    ...
    # output = integrated_kalman_filter(A, Q, H, R, X, y, m0, P0)
    # if return_v_S:
    #     return output
    # else:
...
@jax.jit
def integrated_kalman_filter(A, Q, H, R, t, y, m0, P0):
    '''
